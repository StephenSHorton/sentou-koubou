...
public static class WhitneyCombatVisuals
{
    ...
    /// <summary>
    /// Frame packs under <c>res://Whitney/images/combat/{state}/</c>.
    /// Ranges match tools/char-anim-pipeline/export/whitney/manifest.json.
    /// </summary>
    ...
    [
        ...
        ("hit", 1, 10, false, ["hit", "Hit", "hurt", "Hurt"]),
        ("dead", 1, 24, false, ["dead", "Dead", "die", "Die"]),
    ];
