...
using Godot;
using HarmonyLib;
using Whitney.Scenes.Vfx.SparkProjectile;
...
/// <summary>
/// Marisa-style Harmony patches + script lookup. Invoked from <see cref="MainFile.Initialize"/>
/// (single [ModInitializer] lives on MainFile so we don't double-init).
/// </summary>
public class Entry
{
    public const string LogPrefix = "[Whitney]";
    ...
    public static void Init()
    {
        ...
        var harmony = new Harmony("Whitney");
    ...
    class FrameMaterialPatch
    {
        ...
        {
            if (__instance is AbstractWhitneyCard && characterCard.Contains(__instance.Rarity) )
            {
                __result = null;
                return false;
            }
    ...
    public static class ProgressSaveManager_ObtainCharUnlockEpoch_Patch
    {
        ...
        {
            return localPlayer.Character is not WhitneyCharacter;
        }
    }
    ...
    public static class ProgressSaveManager_CheckFifteenBossesDefeatedEpoch_Patch
    {
        private static bool Prefix(ProgressSaveManager __instance, Player localPlayer)
        {
            return !(localPlayer.Character.Id.ToString().Contains("Whitney", StringComparison.OrdinalIgnoreCase));
        }
    }
    ...
    //     {
    //         if (player.Character is WhitneyCharacter)
    //         {
    ...
    // private const string CookiePath = "yummy_cookie_whitney";
    //
    ...
    //         }
    //
    //         if (__instance.Owner.Character is WhitneyCharacter)
    //         {
    //             __result = CookiePath;
    //             return false;
    //         }
    ...
    //             if (player != null && player.Character is WhitneyCharacter)
    //             {
    //                 
    //                 
    //                 return false;
    ...
    //                 if (character is WhitneyCharacter)
    //                 {
    //                     SteamSetRichPresence.Value?.Invoke(null, ["Character", "DEFECT"]);
    //                     SteamSetRichPresence.Value?.Invoke(null, ["Ascension", "Whitney - A" + State.AscensionLevel]);
    //                 }
    //             }
    //         }
    //     }
    ...
    //         if (prefix == "whitney")
    //         {
    //             __result = "res://Whitney/images/ui/cardEnergyWhitney.png";
    //             return false;
    //         }
