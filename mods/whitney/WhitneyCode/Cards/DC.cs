...
public class DC : AbstractWhitneyCard
{
    ...
    protected override IEnumerable<IHoverTip> ExtraHoverTips =>
        base.ExtraHoverTips.Concat(HoverTipFactory.FromEnchantment<InkboundEnchantment>());
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        var zaEnchantment = Enchantment<InkboundEnchantment>().ToMutable();
        ...
        foreach (var card in cards)
        {
            ...
            zaEnchantment = Enchantment<InkboundEnchantment>().ToMutable();
