...
public sealed class Missing() : BrennenCard(1, CardType.Attack, CardRarity.Common, TargetType.AnyEnemy)
{
    ...
    [
        ...
        new DamageVar("WeakDamage", 11, ValueProp.Move),
    ];
    ...
    protected override void OnUpgrade()
    {
        ...
        DynamicVars["WeakDamage"].UpgradeValueBy(2m);
    }
}
